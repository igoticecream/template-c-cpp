#======================================================================
# Makefile for mixed C/C++ sources (igoticecream 2020)
#======================================================================

#----------------------------------------------------------------------
# Functions
#----------------------------------------------------------------------
rwildcard     = $(wildcard $1$2) $(foreach d,$(wildcard $1*),$(call rwildcard,$d/,$2))                                                   # $(call rwildcard,$(CSOURCES),*.c)
check_defined = $(strip $(foreach 1,$1,$(if $(value $1),,$(error Undefined $1$(if $2, ($2))$(if $(value @), required by target `$@'))))) # $(call check_defined,ENV_NAME,Please export the env variable)
